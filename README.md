...
## Состав репозитория
1. setup.sh — Базовая подготовка сервера. Скрипт предназначен для "фундаментальной" настройки системы:
...
2. setup_warp.sh — Настройка AmneziaWG. Скрипт для создания выходного узла через Cloudflare WARP с маскировкой:
